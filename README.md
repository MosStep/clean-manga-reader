...
- 🧭 **ตรวจผลการดึงข้อมูลตามอุปกรณ์:** ระบบแยกผลเว็บตอบช้า, ถูกกัน, โครงสร้างไม่ตรง และหมดรายการ; เว็บที่รอบนี้อ่านไม่ได้ถูกรวมซ่อนไว้จากแถบหลัก โดยไม่สรุปว่าเว็บต้นทางล่ม
- 📱 **ตัวอ่านเหมาะกับมือถือ:** เลือกเลื่อนยาวหรืออ่านทีละหน้า พร้อมปุ่มเปลี่ยนหน้าด้านล่างและพื้นที่แตะด้านข้างภาพ
- 🔄 **อัปเดตหน้าแรกอัตโนมัติ:** โหลดรายการเมื่อเปิดหน้า และตรวจรายการใหม่ทุก 30 นาทีขณะเปิดแท็บไว้
